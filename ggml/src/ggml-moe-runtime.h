...
ggml_moe_slot_state * ggml_moe_runtime_bank_of(ggml_moe_runtime * runtime, const ggml_tensor * src);
bool ggml_moe_runtime_has_expert(const ggml_moe_slot_state * state, int expert);
